    ...
    withSystem conf.hostPlatform.system ({ system, inputs', self', ... }:
      ...
      in lib.nixosSystem {
        modules = [
          ...
          (builtins.pathExists "${configDir}/configuration.nix")
          [ "${configDir}/configuration.nix" ]
          ++ lib.optionals (builtins.pathExists "${configDir}/hardware.nix")
                ...
                users = mapAttrs (name: hmConf:
                  ...
                  in {
                    imports = [
                      ...
                      (builtins.pathExists "${configDir}/home.nix")
                      [ "${configDir}/home.nix" ];
                  }) conf.home-manager;
              };
            })
...
in { flake.nixosConfigurations = generateSystem cfg; }
